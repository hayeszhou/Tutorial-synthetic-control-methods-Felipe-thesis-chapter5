...
#In the treatment vector the control municipalities are also included, this is because placebo regions are created this way 
...
It can be seen that Loss V in the list list.synth is the mean predicted square error before the treatment (before 2011)
